...
public:
    ...
    py::dict     readTile(int dx, int dy, int part_index = 0,
                          int level_x = 0, int level_y = 0,
                          bool separate_channels = false);
    py::dict     readTiles(int dx1, int dx2, int dy1, int dy2,
                           int part_index = 0, int level_x = 0, int level_y = 0,
                           bool separate_channels = false);
